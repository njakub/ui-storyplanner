...
function validateCharacter(course) {
  if (!course.firstName) return "First Name is required.";
  if (!course.secondName) return "Second Name is required.";
  if (!course.dob) return "DOB is required.";
  return "";
}
